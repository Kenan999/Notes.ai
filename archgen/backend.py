"""
Backend Module — Server-side service descriptions.

The backend consists of two Python servers, a shared SQLite database,
and utility scripts for database management.
"""
