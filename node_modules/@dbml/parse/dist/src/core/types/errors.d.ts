...
export declare enum CompileErrorCode {
    ...
    INVALID_USE_CONTEXT = 3082,
    INVALID_USE_SPECIFIER_KIND = 3083,
    INVALID_USE_SPECIFIER_NAME = 3084,
    INVALID_DIAGRAMVIEW_CONTEXT = 3085,
    DUPLICATE_DIAGRAMVIEW_NAME = 3086,
    INVALID_DIAGRAMVIEW_FIELD = 3087,
    DUPLICATE_DIAGRAMVIEW_FIELD = 3088,
    BINDING_ERROR = 4000,
